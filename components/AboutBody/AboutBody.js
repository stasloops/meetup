...
export default function AboutBody() {
  const dataForCards = [
    ...
    },
    {
      ...
      text:
        'Здесь вы можете предложить услуги аренды конференц-залов и оборудования, ' +
        'кейтеринга, производства атрибутики для конференций и т.д.',
      ...
      <AboutBodyWrapper id="about-id">
        <BodyContentWrapper>
          <AboutBodyHeader>
            ...
            <BodyHeaderText>
              Мероприятия распределены по направлениям — от аналитики и тестирования до дизайна и геймдева. С помощью
              фильтров можно получить подборку событий по формату — онлайн и офлайн, платные и бесплатные, большие и
              небольшие.
            </BodyHeaderText>
            {/* <AboutBodySvg>
      ...
      <BodyFooterContentWrapper>
        <AboutBodyFooter>
          <BodyFooterInfo>
            ...
            <BodyFooterInfoText>
              Единовременно на GoMeetUp размещается больше событий, чем на аналогичных сайтах — вы точно не пропустите
